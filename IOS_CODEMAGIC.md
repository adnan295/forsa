...
Select branch `main` and scan for the root `codemagic.yaml`.
...
4. Check the existing app's version and latest uploaded build in App Store Connect. Start the workflow with the intended release version and a new higher build number. Defaults are 1.1.0 (14); confirm against App Store Connect and increment after every successful upload. See RELEASE.md before publishing.
