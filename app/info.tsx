...
function AboutContent() {
  return (
    <>
      <ContentCard title="ما هو NAYVO؟">
        <Text style={styles.paragraph}>
          NAYVO هو متجر إلكتروني يقدم منتجات مميزة بأسعار مناسبة، ومع كل عملية شراء تحصل على فرصة للحصول على هدايا قيمة. نقدم تجربة تسوّق آمنة وشفافة مع نظام هدايا عادل يضمن فرصاً متساوية لجميع المشترين.
        </Text>
      </ContentCard>
  ...
  return (
    <>
      <ContentCard title="١. القبول بالشروط">
        <Text style={styles.paragraph}>
          باستخدامك لتطبيق NAYVO، فإنك توافق على الالتزام بهذه الشروط والأحكام. إذا كنت لا توافق على أي جزء منها، يُرجى عدم استخدام التطبيق.
        </Text>
      </ContentCard>
