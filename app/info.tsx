...
const CONTENT: Record<Exclude<PageType, "contact">, Section[]> = {
  about: [
    ...
    },
    {
      ...
      items: [
        ...
        { icon: "card", text: "دفع آمن بالتحويل البنكي" },
  ...
  terms: [
    ...
    {
      kind: "bullets",
      title: "٦. القواعد الرسمية للسحب والجهة الراعية",
      items: [
        "الجهة المنظِّمة والراعية الوحيدة للسحوبات هي NAYVO، وهي المسؤولة عن الجوائز وتسليمها",
        "Apple Inc. ليست راعية لهذه السحوبات ولا علاقة لها بها بأي شكل، ولا تتحمّل أي مسؤولية عنها",
        "Google LLC ليست راعية لهذه السحوبات ولا علاقة لها بها بأي شكل، ولا تتحمّل أي مسؤولية عنها",
        "المشاركة للمستخدمين بعمر 18 سنة فأكثر، والتوصيل وتسليم الجوائز داخل سوريا فقط",
        "القسيمة تُمنح مع الشراء فقط ولا تُباع منفصلة، ولا تُستبدل بمال",
        "الفائز يُختار بمولّد أرقام عشوائية آمن من كل القسائم المؤكدة في الجولة، ويُعلن داخل التطبيق في «السحوبات السابقة»",
        "نتواصل مع الفائز عبر التطبيق والبريد ورقم الهاتف المسجّل لترتيب تسليم الجائزة",
      ],
    },
    {
      kind: "text",
  ...
  privacy: [
    {
      ...
      items: [
        "بيانات الحساب: اسم المستخدم والبريد الإلكتروني والاسم الكامل",
        "عند الدخول عبر Apple أو Google: معرّف حسابك لدى المزوّد والبريد الذي يشاركه معنا (قد تعطينا Apple بريداً وسيطاً يخفي بريدك الحقيقي). لا نطّلع على كلمة سرّك أبداً",
        "بيانات الطلبات والشحن: المنتجات والمبالغ، والاسم ورقم الهاتف والمدينة والعنوان",
        "إيصالات الدفع: صور إيصالات التحويل البنكي، تُحفظ بشكل خاص ونحذف منها الموقع الجغرافي وبيانات الكاميرا",
        "رمز الإشعارات الخاص بجهازك، لإرسال تنبيهات الطلبات والسحب",
        "لا نستخدم إعلانات ولا أدوات تتبّع أو تحليلات من أطراف ثالثة",
      ],
    },
    {
      kind: "bullets",
      ...
      items: [
        ...
        "التحقق من المدفوعات ومنح القسائم",
        "إجراء السحب وتسليم الجوائز للفائزين",
        "إرسال إشعارات الطلبات وتذكيرات السحب (تقدر توقفها من إعدادات جهازك)",
    ...
    },
    {
      ...
      items: [
        "Apple وGoogle: لتسجيل الدخول إن اخترته، ولإيصال الإشعارات إلى جهازك",
        "مزوّد البريد الإلكتروني: لإرسال رموز التحقق وتحديثات الطلبات",
        "جهة التوصيل: الاسم ورقم الهاتف والعنوان فقط، لتوصيل طلبك أو جائزتك",
    ...
    },
    {
      ...
      body: "نحمي بياناتك باتصال مشفّر (HTTPS) وصلاحيات وصول محدودة لفريق الإدارة. تبقى بياناتك محفوظة طالما حسابك فعّال، وتُحذف عند حذف الحساب.",
    },
    {
      kind: "bullets",
      title: "حقوقك",
      items: [
        ...
        "تصحيح بياناتك أو تحديثها من «حسابي ← بياناتي»",
        "حذف حسابك نهائياً من «حسابي ← حذف الحساب»: نحذف بياناتك وطلباتك وقسائمك وصور إيصالاتك، ونفك ربط الدخول عبر Apple",
