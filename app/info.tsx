    ...
    <>
      <ContentCard title="ما هو لاكي درو؟">
        <Text style={styles.paragraph}>
          لاكي درو هو تطبيق سحوبات إلكتروني يتيح لك فرصة الفوز بجوائز قيمة من خلال شراء تذاكر بأسعار مناسبة. نقدم تجربة شراء آمنة وشفافة مع نظام سحب عادل يضمن فرصاً متساوية لجميع المشاركين.
        </Text>
      </ContentCard>
      <ContentCard title="كيف يعمل التطبيق؟">
        <BulletPoint text="تصفّح الحملات المتاحة واختر الجائزة التي تريدها" />
        <BulletPoint text="اشترِ عدد التذاكر الذي ترغب به" />
        <BulletPoint text="أكمل عملية الدفع عبر التحويل البنكي" />
        <BulletPoint text="انتظر حتى تنفد جميع التذاكر" />
  ...
  return (
    <>
      ...
      <ContentCard title="٤. عمليات الشراء والدفع">
        <Text style={styles.paragraph}>
          جميع عمليات الشراء نهائية وغير قابلة للاسترجاع بعد تأكيد الدفع. يتم التحقق من جميع المدفوعات قبل إصدار التذاكر.
        </Text>
      </ContentCard>
      <ContentCard title="٥. السحب والجوائز">
        <Text style={styles.paragraph}>
          يتم السحب بشكل عشوائي باستخدام خوارزميات مشفّرة عند اكتمال بيع جميع التذاكر. نتائج السحب نهائية وغير قابلة للاعتراض. يتم شحن الجوائز خلال 14 يوم عمل.
        </Text>
      </ContentCard>
  ...
  return (
    <>
      <ContentCard title="المعلومات التي نجمعها">
        ...
        <BulletPoint text="بيانات الطلبات: تاريخ الشراء، المبالغ، التذاكر" />
      ...
      <ContentCard title="كيف نستخدم بياناتك">
        <BulletPoint text="معالجة طلباتك وإصدار التذاكر" />
