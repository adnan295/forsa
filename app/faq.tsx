...
const FAQ_DATA = [
  {
    question: "ما هو NAYVO؟",
    answer: "NAYVO هو متجر إلكتروني يقدم منتجات حقيقية مع فرصة للحصول على هدايا قيمة. عند شراء أي منتج، تحصل على فرصة هدية تلقائياً كمكافأة إضافية.",
  },
  {
